...
namespace CthululemanItems
{
    ...
    public class CthululemanItemsPlugin : BaseUnityPlugin
    {
        internal const string ModName = "CthululemanItems";
        ...
        public static readonly ManualLogSource CthululemanItemsLogger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                CthululemanItemsLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                CthululemanItemsLogger.LogError($"There was an issue loading your {ConfigFileName}");
                CthululemanItemsLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
